...
- **ブランド名取得モード**: ASINからブランド名のみを取得する専用モード追加
- **プロンプトテンプレート管理**: カスタムプロンプトの作成・編集・削除が可能に
- **キーワードクレンジング機能**: AI生成後に重複削除・語数制限を自動適用
- **AIプロンプト大幅改善**: フレーズベース抽出、厳格制約、モード別詳細化
- **ブランド取得強化**: アメリカAmazon対応、8種類のセレクターで柔軟に取得
